class Public::FilmFilesController < ApplicationController
	...
	def download
		...
		@file.film.save
		send_file @file.real_name.path, content_type: @file.real_name.content_type, length: @file.size
	end
	...
	def part
		...
		part.film.save
		send_file part.real_name.path, content_type: part.real_name.content_type, length: @file.size
	end
