class RemoveNullFalseFromFilms < ActiveRecord::Migration
  def up
  	# films
    ...
    change_column_null(:films_qualities, :position, true)  
    # films_trailers
    ...
    change_column_null(:films_translations, :position, true)	
  end
